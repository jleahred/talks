...
image::lang_abundance4.png[width=1024, align="center"]

<<<
[gray]#Prog lang, one more?#


image::lang_abundance3.png[width="1024", align="center"]

<<<
[gray]#Prog lang, one more?#

image::lang_abundance2.png[width="1024", align="center"]

<<<
[gray]#Prog lang, one more?#

.http://exploringdata.github.io/vis/programming-languages-influence-network/
image::lang_abundance1.png[align="center"]


== Tiobe historical popularity
[gray]#Prog lang, one more?#

image::tiobe_popularity.png[align="center"]


<<<
[gray]#Prog lang, one more?#

image::tiobe_long_term_.png[align="center"]


== Tiobe increment 2014
[gray]#Prog lang, one more?#


image::tiobe_increasing2014.png[align="center"]
...
image::tiobe_hall_of_fame_.png[align="center"]
...
*declaratives* and reemplacements for C++

.http://langpop.corger.nl/
image::lang_popularity_.png[align="center"]

<<<
[gray]#Prog lang, one more?#

image::lang-rank-114-wm_.png[align="center"]


== New repositories Github
[gray]#Prog lang, one more?#


image::github_new_repos-custom.png[width="1024", align="center"]
...
image::lang_pop_normalized_.png[align="center"]

== More stats
[gray]#Prog lang, one more?#

image::pop_lang_bubble_.jpg[align="center"]

== Too many
[gray]#Prog lang, one more?#

image::abrumado.jpg[align="center", width=780]
...
|====================
^a|image::question-mark.jpg[width="150"]

a|:incremental!:
* Too many natural languages           
* Just one mathematical language    
...
image::../images/beer.jpg[align='center']


== Taste, flamware and fans
[gray]#Prog lang, one more?#
...
image::functional-programming-joke.png[width=500, align="center"]
|==================

<<<
[gray]#Prog lang, one more?#

[red big]#WHAT and HOW#
...
[gray]#Prog lang, one more?#
    ...
    * Imperative languages are adopting functional concepts
+
[cols=2, frame="none", grid="none", align="center"]
|==================
a|
[horizontal]
Java:: lambdas, comprehesions lists
C++:: templates, lambdas
Python:: lambdas, first order functions...
...
image::herb_sutter.jpg[width=400, align="center"]


http://en.wikipedia.org/wiki/Herb_Sutter#The_Free_Lunch_Is_Over
...
image::moore_over.jpg[width=400, align="center"]
|==================
...
image::panic.gif[width=400, align="center"]
|==================
